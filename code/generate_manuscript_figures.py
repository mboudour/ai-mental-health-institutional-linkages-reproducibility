...
def figure_1_design(manifest: dict[str, Any], edge_summary: pd.DataFrame, out: Path) -> None:
    ...
    draw_box(ax, (0.30, 4.95), 2.50, 1.15, "Candidate publication retrieval\n13,574 publications", LIGHT_BLUE, fontsize=8.8)
    draw_box(ax, (3.20, 4.95), 2.75, 1.15, "Local literal screen\nAI/ML + core mental-health terms", LIGHT_GOLD, fontsize=8.8)
    draw_box(ax, (6.35, 4.95), 2.50, 1.15, f"Publication anchor P\n{p_n:,} publications", LIGHT_TEAL, fontsize=8.8)
    arrow(ax, (2.84, 5.53), (3.16, 5.53))
    arrow(ax, (5.99, 5.53), (6.31, 5.53))
    ...
    arrow(ax, (7.60, 4.92), (3.35, 2.34))
    arrow(ax, (7.60, 4.92), (7.28, 2.34))
